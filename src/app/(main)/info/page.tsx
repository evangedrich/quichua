...
export default function Info() {
  const text1 = {
    ...
    es: `Esta aplicación multiplataforma es una adaptación del documento <i>Introducción al quichua de la Sierra Central de Ecuador, o Quichua en diez lecciones fáciles (las otras 40 son más difíciles)</i>, de Ellen M. Ross, preparado por <a href="https://quichua.net/" target="_blank">Richard P. Aschmann</a>, y está diseñada como una herramienta digital para el aprendizaje del quichua ecuatoriano hablado con la ayuda de un tutor de quichua.`,
  }; const text2 = {
